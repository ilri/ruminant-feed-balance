...
periurban <- rast("SpatialData/inputs/Lvst_system/w001001.adf") #1-4 = rangelands; 5-8 = mixed systems; 9-14 = irrigated
...
terra::writeRaster(sum(MERhorse, MERdonkey, na.rm = T), 'SpatialData/outputs/horseDonkeyMER_MJ_2015.tif', overwrite = T)
