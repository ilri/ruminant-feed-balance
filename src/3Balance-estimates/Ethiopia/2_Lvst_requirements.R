...
terra::writeRaster(sum(MERhorse, MERdonkey, MERcamel, na.rm = T), 'SpatialData/outputs/horseDonkeyCamelMER_MJ_2015.tif', overwrite = T)
...
#Maintenance
weighted.mean(c(MERm_DS_Highland_cow, MERm_WS_Highland_cow), c(as.numeric(global(lv[[7]]*(lv[[4]]==1)*(lv[[5]]==0), 'mean', na.rm = T)), as.numeric(global(lv[[6]]*(lv[[4]]==1)*(lv[[5]]==0), 'mean', na.rm = T))))
weighted.mean(c(MERm_DS_Highland_sheep, MERm_WS_Highland_sheep), c(as.numeric(global(lv[[7]]*(lv[[4]]==1)*(lv[[5]]==0), 'mean', na.rm = T)), as.numeric(global(lv[[6]]*(lv[[4]]==1)*(lv[[5]]==0), 'mean', na.rm = T))))
weighted.mean(c(MERm_DS_Highland_goat, MERm_WS_Highland_goat), c(as.numeric(global(lv[[7]]*(lv[[4]]==1)*(lv[[5]]==0), 'mean', na.rm = T)), as.numeric(global(lv[[6]]*(lv[[4]]==1)*(lv[[5]]==0), 'mean', na.rm = T))))
