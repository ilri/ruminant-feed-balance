...
download.file(
  ...
  destfile = paste0(outdir, "/manifest_clms_global_ba_300m_v3_monthly_netcdf_latest.txt"))

# Read in manifest
dmp_manifest <- readLines(paste0(outdir, "/manifest_clms_global_ba_300m_v3_monthly_netcdf_latest.txt"))

# Select files of interest
dmp_manifest_list <- grep("NTC_2020", dmp_manifest, fixed=TRUE, value=TRUE) #select a file for each day
